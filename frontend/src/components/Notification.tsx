...
export const Notification = ({
  ...
  return (
    <div
      className={`flex flex-row justify-between bg-green-500 text-white px-4 py-3 rounded fixed max-w-[30%] h-[5rem] bottom-16 left-5 shadow-lg z-50 transition-transform transform ${show ? 'translate-x-0' : 'translate-x-full'
        }`}
      role="alert"
    >
